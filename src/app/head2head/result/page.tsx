...
function HeadToHeadResultContent() {
      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-500">Loading head-to-head data...</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="text-center py-12">
            ...
            <p className="text-gray-500 mb-4">{error || 'Failed to load head-to-head data'}</p>
            <Link href="/head2head">
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <Link href="/head2head" className="inline-flex items-center text-sm text-gray-500 hover:text-gray-700 mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <Card className="p-6">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-semibold text-gray-900">{player1.name}</h2>
                {player1.department && (
                  <p className="text-sm text-gray-500">{player1.department}</p>
                )}
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 text-center">
              <div>
                <div className="text-lg font-semibold text-gray-900">{player1.wins}</div>
                <div className="text-sm text-gray-500">Wins</div>
              </div>
              <div>
                <div className="text-lg font-semibold text-gray-900">{calculateWinRate(player1.wins, player1.losses)}%</div>
          ...
          <Card className="p-6">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-semibold text-gray-900">{player2.name}</h2>
                {player2.department && (
                  <p className="text-sm text-gray-500">{player2.department}</p>
                )}
              </div>
              <div className="text-right">
            ...
            <div className="grid grid-cols-2 gap-4 text-center">
              <div>
                <div className="text-lg font-semibold text-gray-900">{player2.wins}</div>
                <div className="text-sm text-gray-500">Wins</div>
              </div>
              <div>
                <div className="text-lg font-semibold text-gray-900">{calculateWinRate(player2.wins, player2.losses)}%</div>
                <div className="text-sm text-gray-500">Win Rate</div>
              </div>
            </div>
          </Card>
        ...
        <Card className="p-6 mb-8">
          <h3 className="text-xl font-semibold text-gray-900 mb-6">Head-to-Head Statistics</h3>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-center">
              <div>
                <div className="text-lg font-semibold text-gray-900">{averageScore1.toFixed(1)}</div>
                <div className="text-sm text-gray-500">{player1.name} Avg Score</div>
              </div>
              <div>
                <div className="text-lg font-semibold text-gray-900">{averageScore2.toFixed(1)}</div>
        ...
        {matches.length > 0 && (
          <Card className="p-6">
            <h3 className="text-xl font-semibold text-gray-900 mb-6">Match History</h3>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-lg font-bold text-gray-900">{match.player1Score}</span>
                          <span className="text-gray-500">-</span>
                          <span className="text-lg font-bold text-gray-900">{match.player2Score}</span>
